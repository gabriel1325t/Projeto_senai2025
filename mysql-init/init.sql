...
--
-- Host: 127.0.0.1    Database: projeto_senai
-- ------------------------------------------------------
...
CREATE TABLE `reserva` (
  ...
  KEY `fkid_sala` (`fkid_sala`),
  CONSTRAINT `reserva_ibfk_1` FOREIGN KEY (`fkid_usuario`) REFERENCES `usuario` (`id_usuario`),
  CONSTRAINT `reserva_ibfk_2` FOREIGN KEY (`fkid_sala`) REFERENCES `sala` (`id_sala`)
...
-- Dump completed on 2025-03-12 13:16:01
